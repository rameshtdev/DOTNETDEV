...
[System.Web.Services.WebServiceBindingAttribute(Name="GetOrderStatusSoap", Namespace="http://tempuri.org/")]
public partial class GetOrderStatus : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    public GetOrderStatus() {
        this.Url = "http://localhost:49303/GetOrderStatus.asmx";
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetStatus(int OrderId, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetStatus", new object[] {
                    OrderId}, callback, asyncState);
    }
    
    /// <remarks/>
    public OrderStatus EndGetStatus(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((OrderStatus)(results[0]));
    }
